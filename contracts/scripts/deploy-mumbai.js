...
// Note: Polygon Mumbai (chain 80001) was deprecated April 2024.
//       This script targets Polygon Amoy (chain 80002), the current Polygon testnet.
//       Run: npx hardhat run scripts/deploy-mumbai.js --network polygon_testnet
...
async function main() {
  ...
  console.log("\n=== TokenEquityX — Polygon Testnet Deployment ===");
  ...
  if (balance === 0n) {
    throw new Error("Deployer wallet has 0 POL. Get testnet POL from https://faucet.polygon.technology/");
  }
  ...
  console.log("\n1/11 Deploying ComplianceRegistry...");
  ...
  console.log(`      ✓ ${deployed.ComplianceRegistry}`);
  ...
  console.log(`      ✓ ${deployed.KYCManager}`);
  ...
  console.log(`      ✓ ${deployed.SPVRegistry}`);
  ...
  console.log(`      ✓ ${deployed.ValuationOracle}`);
  ...
  console.log(`      ✓ ${deployed.FeeManager}`);
  ...
  console.log(`      ✓ ${deployed.TradeEngine}`);
  ...
  console.log(`      ✓ ${deployed.DistributionManager}`);
  ...
  console.log(`      ✓ ${deployed.GovernanceContract}`);
  ...
  console.log(`      ✓ ${deployed.AssetTokenImplementation}`);
  ...
  console.log(`      ✓ ${deployed.PlatformAdmin}`);
  ...
  const localPath = path.join(__dirname, "..", "deployed_addresses_testnet.json");
  ...
  console.log(`Saved to: deployed_addresses_testnet.json`);
  ...
  console.log(`  https://amoy.polygonscan.com/address/${deployed.ComplianceRegistry}`);
  console.log("\nNext steps:");
  console.log("  1. Copy deployed_addresses_testnet.json values into api/.env");
  console.log("  2. Set RPC_URL=https://polygon-amoy.g.alchemy.com/v2/<KEY> in api/.env");
